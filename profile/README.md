...
Once the architecture, patterns, and key examples are implemented, the project has already fulfilled its purpose. <br>
Each yearly app therefore represents a learning milestone rather than a finished product. <br>

For more context feel free to read this [article](https://sami.eljabali.org/reflections-on-reference-app-development/).
